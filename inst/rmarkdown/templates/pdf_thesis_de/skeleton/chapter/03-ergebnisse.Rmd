...
Hier zum Vergleich in Abb. \@ref(fig:ggplot-fig) die gleiche Grafik nur mit `gglot2` erstellt und mit einer anderen Abbildungsgröße. 

```{r ggplot-fig, fig.cap = "Beziehung zwischen Gesamtpferdestärke und der Reichweite verschiedener Autotypen - mit ggplot2 dargestellt.", fig.width=5, fig.height=3}
ggplot(mtcars, aes(x = hp, y = mpg)) +
  geom_point() +
  geom_smooth(method = "lm") +
  xlab("Pferdestärke") + ylab("Reichweite (in Meilen pro Gallone)")
```
