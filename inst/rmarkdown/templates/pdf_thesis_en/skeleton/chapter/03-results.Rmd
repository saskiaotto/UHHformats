...
Purely for demonstration purposes, figure \@ref(fig:ggplot-fig) shows the same relationship but with `ggplot2` (automatically loaded with tidyverse) and in a different figure size.

```{r ggplot-fig, fig.cap = "Relationship between horsepower and fuel economy - displayed with ggplot2.", fig.width=5, fig.height=3}
