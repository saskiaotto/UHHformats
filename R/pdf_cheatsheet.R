...
#' @param toc_depth integer; Depth of headers to include in table of contents.
#'   Default set to 5.
...
#' @export
pdf_cheatsheet <- function(highlight = "kate", latex_engine = "xelatex",
  toc_depth = 4, ...) {
  pdf_document_format(
    "pdf_cheatsheet", highlight = highlight,
